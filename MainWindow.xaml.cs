...
namespace GridSandbox
{
    ...
    public partial class MainWindow : Window, INotifyPropertyChanged
    {
        ...
        public void playGame()
        {
            ...
            gameForm.Location = new System.Drawing.Point(600, 0);
            gameForm.Show();
        ...
        //returns a normalized point (0 to 1) of either player one hand's location or player two's -- cannot return null point, so use with care
        ...
        //note that this function doesn't tell WHICH location the playerHand is in -- it is necessary for the players to check EACH location
        // and perform logic -- code is generic for grids of unknown sizes -- note global variables numGridRows/Cols

      
        public double playerMove()
        {
            Point handLocation = getPlayerHandLocation(1);
            if (handLocation.Y > .2 && handLocation.Y < .8)
            {
                return handLocation.Y*800-100;
            }
            if (handLocation.Y <= .2)
            {
                return 0;
        ...
        // Student gnerated code should be in this location
        void studentWork()
        {
            
            gameForm.picBoxPlayer.Location = new System.Drawing.Point(0, (int) this.playerMove());
            gameForm.picBoxBall.Location = gameForm.moveBall(gameForm.picBoxBall.Location);
            gameForm.Update();

            //We hope that students will upgrade this bot (hope)
            //We use the gridArray as follows: 0 means the spot is BLANK, 1 means OCCUPIED by player 1, 2 means OCCUPIED by player 2
            //for the purposes of this bot, the user is always player 1


        }//end bracket of studentWork() function
